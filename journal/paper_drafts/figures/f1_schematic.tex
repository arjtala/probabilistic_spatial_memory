...
\coordinate (cellAnchor) at ($(hexcenter) + (16mm, 1mm)$);
...
\node[font=\tiny, above=0.4mm of hll2, anchor=south, xshift=1mm]
...
\node[font=\tiny, below=0.4mm of r3, anchor=north, align=center] (rlab)
     {$R$ exemplars\\\textit{(bounded)}};
\draw[smallflow, dashed, blue!50!black]
     (hC.east) -- ($(cellAnchor) + (-4.5mm, 1.8mm)$);

% ---- query ----
\node[box, right=20mm of cellAnchor, align=center, fill=orange!10,
