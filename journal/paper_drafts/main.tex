...
in-reservoir exemplars---a substrate-correctness property our
single-session sanity check confirms ($R{=}1024$ \caponek{}$=K$
retrieves the same 25 of 187 frames brute-force CLIP does, with
identical mIoU).
...
\psm{}'s cell-targeted retrieval eliminates this structural blind
spot. The C engine ($\sim$700 LoC) and
