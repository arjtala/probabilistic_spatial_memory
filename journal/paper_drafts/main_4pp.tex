...
\caponek{} bound on retrieval fan-out. On a wearable look-back-QA corpus
the bounded substrate retains 83\% of brute-force CLIP Hit@5, recovering
it exactly once reservoir eviction is removed---bounding memory costs
little retrieval accuracy. Scaling to 102.9\,h of metropolitan
...
$0.853$ AUC (vs.\ a $0.498$ shuffled null). The C engine and
evaluation harness are released under MIT.
...
\input{sec4pp_intro_method.tex}
\input{sec4pp_hdd.tex}
\input{sec4pp_validation.tex}
