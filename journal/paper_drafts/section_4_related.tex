...
ring-buffer-aged per-cell state. The H3 grid~\cite{brodsky2018h3}
replaces R-tree subdivisions~\cite{guttman1984rtrees} with equidistant neighbors
and stable ids; the primitives (HyperLogLog~\cite{flajolet2007hyperloglog},
reservoir sampling~\cite{vitter1985reservoir}) are standard---the contribution
is their composition under \caponek{}.
