...
\psm{} indexes per-cell embeddings, not explicit 3D geometry: it is a
bounded-memory substrate \emph{beneath} richer persistent representations
(e.g.\ 3D scene graphs), supplying the streaming, decaying spatial index
they query.
